...
public class Level2 extends Scene {
	...
	private void makePlatforms() {
		...
		makePlatform(p1Builder, 1, new Vector2f(1f, 0f), new Vector2f(1f, 2f));
		makePlatform(p1Builder, 2, new Vector2f(2f, 0f), new Vector2f(1f, 2f));
		makePlatform(p1Builder, 3, new Vector2f(3f, 2f), new Vector2f(1f, 2f));
	}
